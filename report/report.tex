...
\section{Zaklju"cek}
	...
	\begin{figure}[H]
	\begin{center}
	\subfigure[Meja postavljena nizko]{\includegraphics[width=0.6\textwidth]{img/vote_1.png}\label{f-clas-der}}
	\subfigure[Meja postavljena visoko]{\includegraphics[width=0.5\textwidth]{img/vote_2.png}\label{f-clas-heart}}
	\end{center}
